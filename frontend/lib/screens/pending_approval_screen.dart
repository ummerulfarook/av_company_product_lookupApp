                  ...
                  child: Container(
                    ...
                    child: _checking
                        ? const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            SizedBox(width: 12),
                            Text('Checking status...', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: Colors.white)),
                          ])
                        : const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            Icon(Icons.refresh_rounded, size: 20, color: Colors.white),
                            SizedBox(width: 10),
                            Text('Check Approval Status', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.white)),
                          ]),
                  ),
                ),
